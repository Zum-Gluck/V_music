<template>
  <li @click="toSinger(singer)">
    <div class="cover">
      <div class="image">
        <el-image
          :key="singer.img1v1Url + '?param=200y200'"
          :src="singer.img1v1Url + '?param=200y200'"
          lazy
        >
    ...
    <div class="info">
      ...
      <p class="count" v-if="singer.musicSize">单曲数{{ singer.musicSize }}</p>
    </div>
  </li>
</template>
